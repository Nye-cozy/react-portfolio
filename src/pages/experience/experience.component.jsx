...
import Premier from "../../assets/img/experience/premier.png";
                ...
                <Card.Text className="text-center style">
                  ...
                  <ul className="text-left">
                    ...
                    <li>
                      ...
                      bulk query scripts that increased efficiency by 80% and
                      decreased working hours from 4 hours to 30 mins per task.
                    </li>
                    <li>
